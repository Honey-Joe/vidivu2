...
const FEATURES = [
  {
    ...
    title: "Tech Roadmap",
    description:
      "Navigate your learning journey with curated paths designed by industry experts. From foundational concepts to advanced specializations, we provide a clear route to mastery.",
  ...
  },
  {
    ...
    description:
      "Gain access to a vast library of premium study materials. Find comprehensive notes, e-books, and presentations for every subject in your curriculum.",
    highlight: "1000+ Resources",
    bgColor: "bg-blue-50",
    iconColor: "text-blue-600",
    subFeatures: [
      "Subject-wise notes",
      "Curated e-book library",
      "Presentation slides",
    ],
  },
  {
    ...
    title: "Past Papers",
    description:
      "Prepare for exams with an extensive collection of previous year question papers. Understand patterns, manage your time, and ace your assessments.",
  ...
  },
  {
    ...
    title: "Project Guide",
    description:
      "Receive end-to-end guidance for building impactful projects. From ideation and design to deployment and presentation, we support you at every step.",
  ...
  },
  {
    ...
    description:
      "Learn from the best. Read through hundreds of real interview stories and preparation tips shared by seniors and alumni from top companies.",
    highlight: "300+ Experiences",
    bgColor: "bg-indigo-50",
    iconColor: "text-indigo-600",
    subFeatures: [
      "Company-specific experiences",
      "Technical & HR round insights",
  ...
  return (
    ...
    >
      <div className="flex-grow">
        <div
          className={`w-12 h-12 rounded-xl flex items-center justify-center ${feature.bgColor}`}
        >
          <Icon className={`w-6 h-6 ${feature.iconColor}`} />
        </div>
        <h3 className="mt-4 text-xl font-bold font-space text-gray-800">
          {feature.title}
        </h3>
        <p className="mt-2 text-gray-600 font-sans leading-relaxed">
          {feature.description}
        </p>
      </div>
      <div className="mt-6">
    ...
    >
      <div className="w-full lg:w-1/2 xl:w-2/5 px-4 sm:px-0">
        <div className="relative">
          <div
            className={`absolute -left-4 top-1 h-8 w-1 ${feature.bgColor.replace("bg-", "bg-")}`}
            style={{
              backgroundColor: `var(--${feature.iconColor.replace("text-", "color-")})`,
            }}
          ></div>
          <h3 className="font-serif text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">
            {feature.title}
          </h3>
        </div>
    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <motion.span className="block text-gray-500 italic text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl mt-2">
            daw Unaku
          </motion.span>
        </motion.h1>
        ...
        <motion.p
          variants={variants.item}
          className="mt-6 text-base sm:text-lg lg:text-xl text-gray-700 max-w-2xl mx-auto leading-relaxed font-space px-4"
        >
          Built by <span className="font-bold text-gray-900">MCA seniors</span>{" "}
          for juniors – your comprehensive academic and career navigator,
          designed with love and expertise.
        </motion.p>
        ...
        <motion.div className="flex gap-5 justify-center items-center py-10">
          <a href="https://associatonofcomputerapplications.netlify.app/" target='_blank'>
            <motion.button className="group relative inline-flex items-center justify-center overflow-hidden rounded-full bg-gray-800 px-6 py-3 sm:px-8 sm:py-4 font-bold text-white shadow-lg text-sm sm:text-base">
              ACA Website
            </motion.button>
          </a>
  ...
  return (
    <div className="min-h-screen font-sans text-gray-800 overflow-x-hidden">
      ...
      <div className="relative z-10">
        ...
        <main
          id="features"
          className="sm:py-24 md:py-32 bg-gradient-to-b from-#DDF6D2 to-white"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16 md:mb-24">
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold font-serif text-gray-900 px-4">
                Everything You Need, All in One Place
              </h2>
              <p className="mt-4 text-base sm:text-lg text-gray-600 max-w-2xl mx-auto px-4">
                Explore our curated resources designed to help you succeed
